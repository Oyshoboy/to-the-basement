...
namespace RayFire
{
    ...
    public class RFStress
    {
        ...
        // Hidden
        [HideInInspector] public List<RFShard> strShards; // TODO Make nonserialized because recollected at initialize
        [HideInInspector] public List<RFShard> supShards; // TODO Make nonserialized because recollected at initialize
        [HideInInspector] public Vector3       rotCache;
        [HideInInspector] public Vector3       grvCache;
        [HideInInspector] public int           supCache;
        [HideInInspector] public float         sizeCache;
